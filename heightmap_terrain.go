...
// HeightmapTerrainMaterial can render and manipulate a terrain heightmap.
type HeightmapTerrainMaterial struct {
	material.Standard
...
// NewHeightmapTerrainMaterial initializes a terrain with OpenSimplex noise.
func NewHeightmapTerrainMaterial(resolution int) *HeightmapTerrainMaterial {
	m := &HeightmapTerrainMaterial{
...
func (m *HeightmapTerrainMaterial) RenderSetup(gl *gls.GLS) {
...
func heightmapTerrainDemo() {
	...
	terrain := NewHeightmapTerrainMaterial(1024)
